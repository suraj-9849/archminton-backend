...
router.get('/', validate(getVenuesValidation), adminVenueController.getAllVenues);
...
router.post('/', validate(createVenueValidation), adminVenueController.createVenue);
...
router.get('/:id', validate(venueIdValidation), adminVenueController.getVenueById);
...
router.put('/:id', validate(updateVenueValidation), adminVenueController.updateVenue);

// Delete venue
router.delete('/:id', validate(venueIdValidation), adminVenueController.deleteVenue);
...
router.post('/:id/access', validate(grantAccessValidation), adminVenueController.grantVenueAccess);
